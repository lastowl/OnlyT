...
public class TalkScheduleItem : ObservableObject
{
    ...
    /// <summary>
    /// Gets the brush color for overtime display (green for under time, red for overtime)
    /// </summary>
    public IBrush OvertimeBrush
    {
        get
        {
            if (CompletedTimeSecs == null || CompletedTimeSecs == 0)
            ...
            var overtimeSecs = (int)(ActualDuration.TotalSeconds - CompletedTimeSecs);
            return overtimeSecs >= 0 ? Brushes.Green : Brushes.Red;
        }
    }
